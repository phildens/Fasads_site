...
from .views import (
    ...
    BasketItemsAPIView, ProductDetailAPIView, AllProductsAPIView, CategoryDetailAPIView
)
...
urlpatterns = [
    ...
    path("api/categories/<str:category_key>/products/", CategoryProductsAPIView.as_view(), name="api-category-products"),
